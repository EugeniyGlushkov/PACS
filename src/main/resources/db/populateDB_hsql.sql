...
INSERT INTO visitors (temp_num, last_name, first_name, second_name, description, enter_time, exit_time) VALUES
  ('300320181', 'Иванов', 'Иван', 'Иванович', 'Посещение отдела кадров.', '2018-30-03T08:45', '2018-30-03T13:52'),            /*10000*/
  ('100120192', 'Петров', 'Пётр', 'Петрович', 'Посещение отдела инвентаризации.', '2019-10-01T10:22', '2019-10-01T13:54'),    /*10001*/
  ('110120191', 'Сидоров', 'Сидор', 'Сидорович', 'Посещение отдела инвентаризации.', '2019-10-01T12:35', '2019-10-01T12:44'), /*10002*/
  ('110120192', 'Иванов', 'Иван', 'Иванович', 'Встреча с секретарём.', '2019-10-01T12:40', NULL),                             /*10003*/
  ('110120193', 'Иванов', 'Пётр', 'Григорьевич', 'Посещение директора.', NULL, NULL);                                         /*10004*/

INSERT INTO employees (dep_id, pos_id, card_num, last_name, first_name, second_name, email) VALUES
  (1, 1, 333222, 'Иванов', 'Иван', 'Иванович', 'ivanov@mail.ru'); /*10005*/
