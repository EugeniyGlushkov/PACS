...
DROP SEQUENCE IF EXISTS CHIEFS_SEQ;
...
CREATE SEQUENCE CHIEFS_SEQ AS INTEGER START WITH 1;
...
CREATE TABLE chiefs
(
  id        INTEGER GENERATED BY DEFAULT AS SEQUENCE CHIEFS_SEQ PRIMARY KEY,
